...
function liveFind(requestDef) {
  ...
  var skip = parseInt(requestDef.skip, 10) || undefined;
  var limit = parseInt(requestDef.limit, 10) || undefined;
  var findRequest = {
    selector: selector.$regex ? requestDef.selector : selector, //due to $regex not working, found by eric1234
    sort: sort,
    fields: fields,
    skip: skip,
    limit: limit
